...
def mediainfo_paste(text: str, title: str) -> str:
    ...
    URL = "https://mediainfo.thekvt.workers.dev/"
    response = requests.post(URL, json={"data": html_content,"days":10})
    if response.status_code == 200:
        return f"https://mediainfo.thekvt.workers.dev/{json.loads(response.json())['key']}"
    else:
        return "https://mediainfo.thekvt.workers.dev/error"
